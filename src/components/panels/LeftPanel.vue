...
const CardIcon = () => h('svg', { viewBox: '0 0 20 20', width: 20, height: 20 }, [h('rect', { x: 1, y: 2, width: 18, height: 16, rx: 3, fill: '#fff', stroke: '#e5e7eb', strokeWidth: 1.5 }), h('rect', { x: 1, y: 2, width: 18, height: 7, rx: '3 3 0 0', fill: '#4F8EF7' })])
